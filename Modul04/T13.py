...
'''
# Ви можете використовувати метод iterdir() об'єкта Path, щоб ітерувати файли та теки в директорії та класифікувати їх у файли та теки. Ось готова функція:
...
folder_path = Path('/шлях/до/вашої/директорії')
file_list, folder_list = parse_folder(folder_path)

print("Файли:", file_list)
print("Теки:", folder_list)
# Замість '/шлях/до/вашої/директорії' вставте реальний шлях, який ви хочете аналізувати. Функція використовує iterdir(), щоб ітерувати файли та теки у вказаній директорії (path). Вона класифікує кожен елемент як файл чи теку та додає ім'я елемента до відповідного списку. На завершення вона повертає списки файлів та тек.