...
def get_random_password():
    password_length = 8
    password_characters = [chr(i) for i in range(40, 127)]

    # Використовуємо функцію choice для вибору випадкового символу
    password = ''.join(choice(password_characters) for _ in range(password_length))
...
# Ця функція генерує випадковий пароль з 8 символів за допомогою функції choice зі списку символів у вказаному діапазоні ASCII кодів. Згенерований пароль потім повертається функцією.
