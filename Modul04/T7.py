...
"""    
def calculate_distance(coordinates):
    # Перевірка, чи список не порожній або має одну координату
    ...
    for i in range(len(coordinates) - 1):
        ...
        point_tuple = tuple(sorted([coordinates[i], coordinates[i + 1]]))
        
        # Додавання відстані до загальної відстані
        total_distance += points.get(point_tuple, 0)

    return total_distance

# Приклад використання:
flight_path = [0, 1, 3, 2, 0]
result = calculate_distance(flight_path)
print("Загальна відстань пролету дрону:", result)
"""
# Ця функція перебирає координати польоту дрону та використовує словник points, щоб знайти відстані між вказаними точками. Загальна відстань обчислюється як сума відстаней між послідовними точками. Якщо список порожній або містить лише одну координату, функція повертає 0.
# CORRECT CODE     
points = {
    (0, 1): 2,
    (0, 2): 3.8,
