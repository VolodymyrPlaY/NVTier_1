...
def number_of_groups(n, k):
    """
    Функція обчислює кількість різних списків переможців при розіграші.
    ...
    if n >= k:
        ...
        return 0  # Якщо k більше за n, то немає можливості вибрати k елементів з n

# Приклад виклику функції
total_people = 50
winners_count = 7
result = number_of_groups(total_people, winners_count)
print(f'Number of different groups of winners: {result}')
# Ця функція використовує рекурсивний підхід для обчислення факторіалу та обчислює число поєднань без повторень за допомогою вказаної формули.
