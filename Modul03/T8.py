...
def cost_delivery(quantity, *args, discount=0):
    # Загальна сума за доставлення з урахуванням знижки
    total_cost = 5 + max(0, quantity - 1) * 2
...
result1 = cost_delivery(2, discount=0)
print(f'Test 1: {result1}')

result2 = cost_delivery(3, discount=0)
print(f'Test 2: {result2}')

result3 = cost_delivery(1, discount=0)
print(f'Test 3: {result3}')

result4 = cost_delivery(2, discount=0.5)
print(f'Test 4: {result4}')
# Ця функція cost_delivery приймає quantity (кількість товарів у замовленні) та параметр discount (знижка за замовчуванням має значення 0). Функція розраховує загальну суму за доставлення з урахуванням знижки та повертає результат. У викликах функції зазначено тестові сценарії для перевірки правильності роботи.
# Тепер функція приймає будь-яку кількість позиційних аргументів (*args). Це дозволяє вам передавати будь-яку кількість товарів у замовленні без створення проблем. В тестових викликах я виправив синтаксис, щоб відображати нову сигнатуру функції.
